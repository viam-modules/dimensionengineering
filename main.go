...
func main() {
	utils.ContextualMain(mainWithArgs, module.NewLoggerFromArgs("dimensionengineering"))
}
...
func mainWithArgs(ctx context.Context, args []string, logger logging.Logger) error {
	...
	if err = module.AddModelFromRegistry(ctx, motor.API, sabertooth.Model); err != nil {
		return err
	}
